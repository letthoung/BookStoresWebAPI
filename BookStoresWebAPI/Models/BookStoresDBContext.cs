...
namespace BookStoresWebAPI.Models
{
    public partial class BookStoresDBContext : DbContext
    {
        ...
        public BookStoresDBContext(DbContextOptions<BookStoresDBContext> options, IConfiguration configuration)
            : base(options)
        {
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            if (!optionsBuilder.IsConfigured)
            {
                ...
                optionsBuilder.UseSqlServer(Configuration.GetConnectionString("BookStoresDB"));
            }
        }
